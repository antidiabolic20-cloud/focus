            ...
            <div className="flex items-center gap-4">
                ...
                <div className="hidden sm:block w-48 lg:w-96 relative group">
                    ...
                    <input
                        type="text"
                        placeholder="Search..."
                        className="w-full bg-background-lighter border border-glass-border rounded-xl pl-10 pr-4 py-2 text-sm text-white focus:outline-none focus:border-primary/50 transition-all"
                    />
                </div>
            </div>
