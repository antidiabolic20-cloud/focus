    ...
    return (
        <header className="h-20 fixed top-0 right-0 left-0 md:left-64 bg-background/80 backdrop-blur-md border-b border-glass-border z-40 px-4 md:px-8 flex items-center justify-between">
            <div className="flex items-center gap-4">
                ...
                {isFocusMode && (
                    <div className="flex items-center gap-2 px-3 py-1.5 bg-primary/20 border border-primary/50 rounded-full animate-pulse">
                        <div className="w-2 h-2 bg-primary rounded-full box-shadow-neon"></div>
                        <span className="text-xs font-bold text-primary-light hidden sm:inline">Strive for Success Mode</span>
                        <span className="text-xs font-bold text-primary-light sm:hidden">Focus Mode</span>
                    </div>
                )}
